...
import com.kvanzi.jwtauth.exception.UsernameTakenException;
import com.kvanzi.jwtauth.mapper.UserMapper;
import com.kvanzi.jwtauth.repository.UserRepository;
...
public class UserService {
    ...
    public @NonNull PrivateUserResponse createUser(@NonNull CreateUserRequest requestBody) {
        ...
        if (encodedPassword == null) {
            throw new IllegalStateException("Password encoder returned null value");
        }
