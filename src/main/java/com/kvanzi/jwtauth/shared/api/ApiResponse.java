...
public class ApiResponse<D, M> {
    ...
    public ApiResponse(@NonNull HttpStatus status, @NonNull String message, @Nullable M meta, @Nullable D data) {
    ...
    public static <D> ResponseEntity<@NonNull ApiResponse<@NonNull D, @Nullable Void>> success(@NonNull D data) {
        return success(HttpStatus.OK, DEFAULT_SUCCESS_MESSAGE, data);
    }

    public static <D> ResponseEntity<@NonNull ApiResponse<@NonNull D, @Nullable Void>> success(@NonNull String message,
                                                                                               @NonNull D data) {
        return success(HttpStatus.OK, message, data);
    }

    public static <D> ResponseEntity<@NonNull ApiResponse<@NonNull D, @Nullable Void>> success(
        @NonNull HttpStatus status, @NonNull String message, @Nullable D data) {
    ...
    public static <D> ResponseEntity<@NonNull ApiResponse<@NonNull D, @Nullable Void>> success(
        @NonNull HttpStatus status, @NonNull String message, @Nullable D data, @Nullable URI location) {
        validateSuccessStatus(status);
        ApiResponse<D, Void> response = new ApiResponse<>(status, message, null, data);
    ...
    public static <D, M> ResponseEntity<@NonNull ApiResponse<@NonNull D, @NonNull M>> successWithMeta(@NonNull D data,
                                                                                                      @NonNull M meta) {
    ...
    public static <D, M> ResponseEntity<@NonNull ApiResponse<@NonNull D, @NonNull M>> successWithMeta(
        @NonNull String message, @NonNull D data, @NonNull M meta) {
        return successWithMeta(HttpStatus.OK, message, data, meta);
    }

    public static <D, M> ResponseEntity<@NonNull ApiResponse<@NonNull D, @NonNull M>> successWithMeta(
        @NonNull HttpStatus status, @NonNull String message, @NonNull D data, @NonNull M meta) {
        validateSuccessStatus(status);
    ...
    public static <M> ResponseEntity<@NonNull ApiResponse<@Nullable Void, @NonNull M>> successOnlyMeta(
        @NonNull String message, @NonNull M meta) {
        return successOnlyMeta(HttpStatus.OK, message, meta);
    }

    public static <M> ResponseEntity<@NonNull ApiResponse<@Nullable Void, @NonNull M>> successOnlyMeta(
        @NonNull HttpStatus status, @NonNull String message, @NonNull M meta) {
        validateSuccessStatus(status);
    ...
    public static ResponseEntity<@NonNull ApiResponse<@Nullable Void, @Nullable Void>> successNoContent(
        @NonNull HttpStatus status, @NonNull String message) {
        validateSuccessStatus(status);
    ...
    public static ResponseEntity<@NonNull ApiResponse<@Nullable Void, @Nullable Void>> successNoContent(
        @NonNull HttpStatus status, @NonNull String message, @Nullable URI location) {
        validateSuccessStatus(status);
        ApiResponse<Void, Void> response = new ApiResponse<>(status, message, null, null);
    ...
    public static <D> ResponseEntity<@NonNull ApiResponse<@NonNull D, @Nullable Void>> created(@NonNull D data,
                                                                                               @NonNull URI location) {
        return success(HttpStatus.CREATED, RESOURCE_CREATED_MSG, data, location);
    }

    public static ResponseEntity<@NonNull ApiResponse<@Nullable Void, @Nullable Void>> created(@NonNull URI location) {
        return successNoContent(HttpStatus.CREATED, RESOURCE_CREATED_MSG, location);
    }

    public static <D> ResponseEntity<@NonNull ApiResponse<@NonNull D, @Nullable Void>> created(@NonNull String message,
                                                                                               @NonNull D data,
                                                                                               @NonNull URI location) {
        return success(HttpStatus.CREATED, message, data, location);
    }

    public static <D, M> ResponseEntity<@NonNull ApiResponse<@NonNull D, @NonNull M>> createdWithMeta(@NonNull D data,
                                                                                                      @NonNull M meta) {
        return successWithMeta(HttpStatus.CREATED, RESOURCE_CREATED_MSG, data, meta);
    }

    public static ResponseEntity<@NonNull ApiResponse<@Nullable Void, @Nullable Void>> error(@NonNull HttpStatus status,
                                                                                             @NonNull String message) {
    ...
    public static <D> ResponseEntity<@NonNull ApiResponse<@NonNull D, @Nullable Void>> errorWithData(
        @NonNull HttpStatus status, @NonNull String message, @NonNull D errorData) {
        validateErrorStatus(status);
    ...
    public static <D> ResponseEntity<@NonNull ApiResponse<@NonNull D, @Nullable Void>> badRequestWithData(
        @NonNull String message, @NonNull D data) {
        return errorWithData(HttpStatus.BAD_REQUEST, message, data);
    }

    public static <M> ResponseEntity<@NonNull ApiResponse<@Nullable Void, @NonNull M>> badRequestWithMeta(
        @NonNull String message, @NonNull M meta) {
    ...
    public String toString() {
        return "ApiResponse:%n{%n\tstatusCode=%d,%n\tmessage='%s',%n\thasData=%s,%n\thasMeta=%s,%n\ttimestamp=%s%n}"
            .formatted(
                status.value(), message, data != null, meta != null, timestamp
            );
    }
}